...
formularios.addEventListener("submit", (event) => {
  ...
  setTimeout(() => {
    ...
    let mensaje =
      "send?phone=" +
      telefono +
      "&text=*_Formulario de contacto NETSA SRL._*%0A*Nombre Completo*%0A" +
      nombre +
      "%0A*Correo Electrónico*%0A" +
      email +
      "%0A*Numero de Celular*%0A" +
      numero +
      "%0A*Fecha de Reserva*%0A" +
      fecha +
      "%0A*Tipo de Plan*%0A" +
      servicio +
      "%0A*Plan Seleccionado*%0A" +
      plan +
      "%0A*Direccion de Domicilio*%0A" +
      ubicacion +
      "";
